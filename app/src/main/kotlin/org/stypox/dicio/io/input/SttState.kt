...
/**
 * Represents all possible states of an STT input device. States like [NotDownloaded],
...
sealed interface SttState {
    ...
    /**
     * Some STT models (e.g. future ONNX Whisper) may be distributed in archives that need unzipping.
     */
